...
//                        LocalDate date = stringToDate(values[3]);
...
//                        LocalDate birthDate = stringToDate(values[4]);
//                        String phoneNumber = values[5];
//                        String email = values[6];
//                        String address = values[7];
//                        LocalDate hireDate = stringToDate(values[8]);
...
//                        Medicine medicine = new Medicine(1,name,price,companyName);
